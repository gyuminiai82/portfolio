...
export default function Footprint({ direction }) {
  ...
  // Cyberpunk Stomping Effect for the Massive Background Human Footprint
  const glitchVariants = {
    ...
    visible: { 
      opacity: [0, 0.7, 0.1, 0.8, 0.2, 0.4, 0.35], // Settles at 0.35 for background
      scale: [1.4, 1, 1.05, 1],
      filter: ["blur(20px)", "blur(0px)", "blur(3px)", "blur(0px)"],
      y: [80, -10, 5, 0],
      x: [0, 10, -10, 5, -5, 0],
      transition: { 
        duration: 0.8, 
  ...
  return (
    <motion.div 
      ...
      ${isLeftFoot ? 'right-[5%] md:right-[10%]' : 'left-[5%] md:left-[10%]'}
      w-[250px] h-[250px] md:w-[500px] md:h-[500px]
      `}
    >
      {/* Human Footprint SVG (Backstep: toes pointing UP) */}
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
        className={`w-full h-full drop-shadow-[0_0_20px_rgba(99,102,241,0.15)] text-indigo-100/70 ${isLeftFoot ? '-rotate-12' : 'scale-x-[-1] rotate-12'}`}>
        <path 
          fill="currentColor"
